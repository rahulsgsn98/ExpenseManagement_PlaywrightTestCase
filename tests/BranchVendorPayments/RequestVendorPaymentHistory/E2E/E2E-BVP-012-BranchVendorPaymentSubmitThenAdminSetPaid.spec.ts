...
test.describe('E2E-BVP-012 Branch Vendor Payment submit then Admin sets Paid', () => {
  test.beforeEach(async ({ page }) => {
    await Pagegoto(page);
    await ensureBranchManagerRoleForEnd2E(page);
  });

  test('Branch Manager submits, Super Admin sets Paid, Branch History shows Paid', async ({ page }) => {
    ...
    const amount = RandomDataFaker.amount(2300, 2399);
